...
export default function Card({imgSrc, title, id, path}) {
    return ( 
  <div key={id} className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
    
    <div className="w-full h-64 bg-gray-300 bg-center bg-cover rounded-sm shadow-md" style={{'backgroundImage': `url(${imgSrc})`}}>
        <span>
