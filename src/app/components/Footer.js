export default function Footer() {
    ...
    <div className="container p-6 mx-auto">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <div>
                        ...
                        <a href="/booking" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Booking</a>
                        <a href="/gallery" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Gallery</a>
                        <a href="/contact" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Contact</a>
                    </div>

                    <div>
                        <h3 className="text-gray-700 uppercase dark:text-white">External</h3>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">WhatsApp</a>
                    ...
                    <div>
                        ...
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Bridal Makeup</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Hairstyles</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Manicure and Pedicure</a>
                    </div>
        ...
        <hr className="h-px my-6 bg-gray-200 border-none dark:bg-pink-700" />
