...
export default function Navbar() {
  ...
  return ( 
    ...
    <div className="container px-3 py-2 mx-auto md:flex md:justify-evenly md:items-center">
        ...
        <div className={`absolute right-0 z-10 w-1/2 p-3 px-6 mt-2 transition-all duration-300 ease-in-out dark:bg-${open?'black':'none'} md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center ${open?'opacity-100 -translate-x-none': 'opacity-0 translate-x-full'}`}>
            ...
            <div class="flex justify-start md:block my-2 md:mt-0">
                <a class="relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="/cart">
                    ...
                    <span class="absolute top-0 left-0 p-1 text-xs text-white bg-pink-600 rounded-full"></span>
                </a>
            </div>
        </div>
    </div>
