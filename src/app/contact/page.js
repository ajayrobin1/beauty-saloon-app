            ...
            <div className="md:w-1/4 md:mx-8 pl-2">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-700">(257) 563-7401</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-700">acb@example.com</span>
                    </p>
                </div>
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        <a className="mx-1.5 dark:hover:text-blue-400 text-gray-900 transition-colors duration-300 transform hover:text-blue-500" href="#">
